...
> {
  ...
  public static readonly Error: SessionExceedAction<any> =
    new SessionExceedAction(() => ({ proceed: false as const }));
  ...
  ): SessionExceedAction<any> {
    return new SessionExceedAction<any>((ctx) => ({

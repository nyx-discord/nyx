...
> implements SessionPromiseRepository<Types> {
  ...
  public static create<
    Types extends InteractionTypes = InteractionTypes,
  >(): SessionPromiseRepository<Types> {
    return new this();
  }
  ...
  public getPromise<const Of extends Session<unknown, Types>>(
    session: Of,
  ...
  public reject<const Of extends Session<unknown, Types>>(
    session: Of,
    reason?: Error,
  ): void {
    const id = session.getId();
  ...
  public resolve<const Of extends Session<unknown, Types>>(
    session: Of,

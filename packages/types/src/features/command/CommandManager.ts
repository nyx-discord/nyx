...
> extends BotLifecycleObserver {
   ...
   */
  execute(
    source: CommandExecutableInteraction<Types>,
    meta?: Metadata,
  ): Awaitable<boolean>;
   ...
   */
  addCommands(...commands: TopLevelCommand<Types>[]): Awaitable<this>;
   ...
   */
  subscribe(
    ...subscribers: EventSubscriber<CommandEventArgs<Types>>[]
  ): Awaitable<this>;
  ...
  getSubscriptions(): CommandSubscriptionsContainer<ClientEventMap>;
   ...
   */
  setSubscriptions(
    subscriptions: CommandSubscriptionsContainer<ClientEventMap>,
  ): Awaitable<this>;

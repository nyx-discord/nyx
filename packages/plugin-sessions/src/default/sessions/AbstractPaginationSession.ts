...
import type { PaginationSession } from '../../core/session/PaginationSession';
import { SessionPlugin } from '../SessionPlugin';
import { AbstractSession } from './AbstractSession';

export abstract class AbstractPaginationSession<Result = void>
  ...
  implements PaginationSession<Result>
{
  ...
  protected extractPageFromButton(
    ...
    const codec = SessionPlugin.getFromBot(this.bot).getCustomIdCodec();

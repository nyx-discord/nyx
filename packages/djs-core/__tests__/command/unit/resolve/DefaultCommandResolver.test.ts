...
const createRepo = () => new DefaultCommandRepository<CoreInteractionTypes>();

const setupParentWithSubcommand = (
  repo: DefaultCommandRepository<CoreInteractionTypes>,
) => {
...
describe('DefaultCommandResolver (@discordjs/core)', () => {

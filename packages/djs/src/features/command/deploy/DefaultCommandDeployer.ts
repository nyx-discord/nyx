...
> {
  ...
  protected pendingAdd: TopLevelCommand<DjsInteractionTypes>[] | null = [];
  ...
  public static create(
    client: Client,
  ): CommandDeployer<DjsInteractionTypes, ApplicationCommand> {
  ...
  protected async deployOnly(
    ...
    const guildAggregate = new Collection<
      Snowflake | null,
      TopLevelCommand<DjsInteractionTypes>[]
    >();
    for (const command of commands) {
